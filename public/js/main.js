...
document.getElementById("myForm").addEventListener("submit", function (event) {
  ...
  if (email) {
    ...
    /* eslint-disable */
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2305014611_54_8_54_33_4", "subscribed")));
