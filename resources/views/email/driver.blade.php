                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="#" title="logo" target="_blank">
                                <img width="100" src="{{ asset('/assets/images/safer-logo.png') }}" title="logo"
                                    alt="logo">
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            A new message arrived.<br/>
                                            {{-- <br><strong>Bellow are .</strong>.</p> --}}
                                        <span
                                        ...
                                        <p
                                            ...
                                            <strong style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Email</strong>{{ $data['email'] }}
                                            <strong style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Message</strong>{{ $data['message'] }}
