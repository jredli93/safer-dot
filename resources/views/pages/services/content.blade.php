        ...
        <div class="grid max-w-screen-xl px-20 pt-20 pb-8 mx-auto items-center h-full lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-10">
                <h1 class="mb-4 text-2xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">EXCELLENCE IN SERVICES PROVIDED IS OUR MISSION AND A COMITMENT TO
                    OUR CLIENTS</h1>
                <p class="mb-6 text-base font-light text-white lg:mb-8 md:text-lg lg:text-xl dark:text-white-400">SaferDOT Solutions is a Transportation Services Agency founded by a former Trucker
                    and Trucking Company Owner who truly knows what your business needs inside and out. Leave
                    all your permits and licensing needs to us, from your company foundation to your daily
                    operations processes. Our team is trained with broad knowledge and with founder extensive
                    past experience to resolve the toughest challenges presented by turbulent freight industry.</p>
                <div class="btn-wrap mt-16 hp-buttons flex flex-col justify-between sm:block">
                    <a href="#test" data-lity class="transition-colors duration-300 ease-in-ou hover:no-underline hover:bg-white font-semibold hover:text-slate-900 py-4 px-6 border-2 border-white rounded-lg">
                        GET YOUR FMCSA AUTHORITY NOW
                    </a>
                    <a href="#inline" data-lity class="transition-colors sm:ml-2 mt-1 sm:mt-auto duration-300 ease-in-ou hover:no-underline hover:bg-white font-semibold hover:text-slate-900 py-4 px-6 border-2 border-white rounded-lg">
    ...
    <div id="test" style="background:#fff" class="lity-hide">
        <form class="grid grid-cols-1 gap-6 p-4 mt-8">
            ...
            <button class="flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-700 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                <span>GET YOUR FMCSA AUTHORITY </span>
    ...
    <div class="bg-slate-100">
        <div class="grid grid-cols-1 gap-4 w-[90%] mx-auto md:grid-cols-2 xl:grid-cols-2 pt-10 pb-10 lg:pb-20" style="cursor: auto;">
    ...
    <section>
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 grid lg:grid-cols-2 xl:gap-16">
                <div class="text-slate-700 sm:text-lg">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-slate-700">Consulting: Leverage the Tools You Already Use</h2>
                    <p class="mb-8 text-slate-700 lg:text-xl">SaferDOT Solutions Consulting Services help you maximize efficiency by integrating seamlessly with the tools you already rely on. We focus on enhancing your operations without the need for complex systems, allowing you to achieve your goals effortlessly.</p>

                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-slate-700">Continuous Integration and Deployment</h2>
                    <p class="mb-8 text-slate-700 lg:text-xl">Streamline your operations by ensuring your systems are always up-to-date and ready to adapt to changing needs.</p>

                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-slate-700">Optimized Development Workflow</h2>
                    <p class="mb-8 text-slate-700 lg:text-xl">Enhance efficiency in your daily tasks, allowing your team to focus on what matters most.</p>

                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-slate-700">Effective Knowledge Management</h2>
                    <p class="mb-8 text-slate-700 lg:text-xl">Facilitate easy access to important information, ensuring your team has the resources they need to succeed.</p>
                    <!-- <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-slate-700">Continuous integration and deployment</span>
                        </li>
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-slate-700">Development workflow</span>
                        </li>
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-slate-700">Knowledge management</span>
                        </li>
                    </ul> -->
                    <!-- <p class="mb-8 text-slate-700 lg:text-xl">Deliver great service experiences fast - without the complexity of traditional ITSM solutions.</p> -->
                </div>
                <img class="w-full mb-4 rounded-lg lg:mb-0 lg:flex " src="{{ asset('/assets/images/graph2.png') }}" alt="dashboard feature image">
            </div>

            <div class="items-center gap-8 grid lg:grid-cols-2 xl:gap-16">
                <img class="w-full order-last lg:order-first  mb-4 rounded-lg lg:mb-0  lg:flex" src="{{ asset('/assets/images/graph.png') }}" alt="feature image 2">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-slate-700">Recruiting: Deliver Exceptional Experiences Quickly</h2>
                    <p class="mb-8 text-slate-700 lg:text-xl">Streamline your recruiting process without the complexities of traditional methods. Accelerate your hiring efforts, reduce manual tasks, and onboard candidates with ease.</p>

                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-slate-700">Customizable Templates for Everyone</h2>
                    <p class="mb-8 text-slate-700 lg:text-xl">Utilize easy-to-adapt templates for openings postings, candidate evaluations, and onboarding to streamline your processes.</p>

                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-slate-700">Streamlined Recruiting Workflow</h2>
                    <p class="mb-8 text-slate-700 lg:text-xl">Enhance the efficiency of your hiring process, allowing your team to focus on attracting top talent.</p>

                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-slate-700">Effective Knowledge Management</h2>
                    <p class="mb-8 text-slate-700 lg:text-xl">Centralize important information and resources to empower your recruiting process and improve collaboration.</p>
                    ...
                    <!-- <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-slate-700">Dynamic reports and dashboards</span>
                        </li>
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-slate-700">Templates for everyone</span>
                        </li>
                        <li class="flex space-x-3">
                        ...
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-slate-700">Limitless business automation</span>
                        </li>
                        <li class="flex space-x-3">
    ...
    <section class="bg-slate-700">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
            <figure class="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    <p class="text-xl font-medium md:text-2xl dark:text-white">&quot;I can&#39;t say enough good things about SaferDOT Solutions! Their team helped us navigate the
                        complexities of safety compliance and permits with ease. From the moment we partnered with
                        them, we noticed a significant improvement in our operations. The consultants were
                        knowledgeable, responsive, and genuinely invested in our success. Thanks to their expertise,
                        we streamlined our recruiting process and ensured we were fully compliant with all industry
                        regulations.&quot;</p>
                </blockquote>
